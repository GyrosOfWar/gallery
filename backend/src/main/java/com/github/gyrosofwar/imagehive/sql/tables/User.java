...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> PASSWORD_HASH = createField(DSL.name("password_hash"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<UserRecord, String> TOTP_SECRET = createField(DSL.name("totp_secret"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.user.user_settings</code>.
     */
    public final TableField<UserRecord, JSONB> USER_SETTINGS = createField(DSL.name("user_settings"), SQLDataType.JSONB.nullable(false), this, "");

    /**
     * The column <code>public.user.created_on</code>.
     */
    public final TableField<UserRecord, OffsetDateTime> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>public.user.last_login</code>.
     */
    public final TableField<UserRecord, OffsetDateTime> LAST_LOGIN = createField(DSL.name("last_login"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function9<? super Long, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super JSONB, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function9<? super Long, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super JSONB, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
