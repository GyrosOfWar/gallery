...
public class Album extends TableImpl<AlbumRecord> {
   ...
   */
  public final TableField<AlbumRecord, String> DESCRIPTION = createField(
   ...
   */
  public final TableField<AlbumRecord, UUID> THUMBNAIL_ID = createField(
    DSL.name("thumbnail_id"),
    SQLDataType.UUID,
    this,
    ""
  );
   ...
   */
  public Image image() {
    if (_image == null) _image = new Image(this, Keys.ALBUM__ALBUM_THUMBNAIL_ID_FKEY);
